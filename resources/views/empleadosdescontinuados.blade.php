...
<i><h4>Da click en el botón verde de "Actualizar" para inhabilitar los empleados que no pertenecen a la compañia</h4></i><br><br>
<form action="{{url('/actualizacionempleadossalientes')}}"  method="post">
	@csrf
	<button type="submit" class="btn btn-success" style="width: 20%; margin-left: 40%;" onclick='ActualizarJefes();'>Actualizar</button>
</form>
