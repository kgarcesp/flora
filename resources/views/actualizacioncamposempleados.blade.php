...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Actualizacion de Campos Empleados') }}</div>
            </div>
        </div>
    </div>
</div><br>
...
<i><h4>Da click en el botón azul de "Actualizar" para Actualizar los Campos de los Empleados</h4></i><br><br>
<form action="{{url('/actualizacioncamposempleadosfinal')}}"  method="POST">
	@csrf
	<button type="submit" class="btn btn-primary" style="width: 20%; margin-left: 40%;" onclick='ActualizarJefes();'>Actualizar</button>
</form>
