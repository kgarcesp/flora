        ...
        <form action="{{url('/updateuserdata')}}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-12">
                           <label for="mascotas"> <h3>Usuario: </h3></label>
                           <input type="text" name="id_user" value="{{$userdata[0]->id}}" style="display: none;">
                           <input type="text" name="user_update_name" disabled="disabled" value="{{$username}}" style="width: 300px;">
                        </div>
                    </div>
                 ...
                 <div class="form-row">
                        <div class="form-group col-sm-12">
                           ...
                           <select class="form-control" id="mascotas" name="mascotas" onchange="SeleccionMascotas();">
                              <option>{{$userdata[0]->mascotas}}</option>
                              <option>No</option>
                              <option>Si</option>
                           </select>
                        </div>
                   @if($userdata[0]->mascotas == 'Si')
                        <div class="form-group col-sm-12" id="div_cantidad_mascotas">
                           <label for="cantidad_mascotas">Cúantas??:</label>
                            <input type="number" class="form-control" id="cantidad_mascotas" name="cantidad_mascotas" placeholder="" value="{{$userdata[0]->cantidad_mascotas}}">
                        </div>
                        <div class="form-group col-sm-12"  id="div_especies">
                           <label for="especie_mascotas">Especie(s):</label>
                            <input type="text" class="form-control" id="especies_mascotas" name="especies_mascotas" placeholder="" value="{{$userdata[0]->especie_mascotas}}">
                        </div>
                        <div class="form-group col-sm-12"  id="div_nombre_mascotas">
                           <label for="nombres_mascotas">Nombre de la(s) mascota(s):</label>
                            <input type="text" class="form-control" id="nombres_mascotas" name="nombres_mascotas" placeholder="" value="{{$userdata[0]->nombre_mascotas}}">
                        </div><br>
                    @else
            ...
            <div class="form-row">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="telefono_fijo" name="telefono_fijo" placeholder="" onkeypress="return valideKey(event);" value="{{$userdata[0]->telefono_fijo}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="correo">Celular personal:</label>
                    <input type="text" class="form-control" id="celular_personal" name="celular_personal" placeholder="" onkeypress="return valideKey(event);"  value="{{$userdata[0]->celular_personal}}">
                </div><br>
                <div class="form-group col-sm-4">
                    <label for="extension">Dirección residencia:</label>
                    <input type="text" class="form-control" id="direccion_residencia" name="direccion_residencia" placeholder=""  value="{{$userdata[0]->direccion_residencia}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Barrio:</label>
                    <input type="text" class="form-control" id="barrio" name="barrio" placeholder=""  value="{{$userdata[0]->barrio}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Nombre Unidad/Urbanización/Condominio:</label>
                    <input type="text" class="form-control" id="nombre_unidad" name="nombre_unidad" placeholder="" onkeypress="return VerificarApto(event);" value="{{$userdata[0]->nombre_unidad}}">
                </div><br>
                <div class="form-group col-sm-4" style="display: none;" id="div_apto">
                    <label for="extension">Número Casa/Apartamento:</label>
                    <input type="text" class="form-control" id="apto" name="apto" placeholder="" value="{{$userdata[0]->apto}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Ciudad residencia:</label>
                    <input type="text" class="form-control" id="ciudad" name="ciudad" placeholder=""  value="{{$userdata[0]->ciudad}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="celular">Estado civil:</label>
                      <select class="form-control" id="estado_civil" name="estado_civil">
                        <option>{{$userdata[0]->estado_civil}}</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="correo_personal" name="correo_personal" placeholder=""  value="{{$userdata[0]->email_aux}}">
                </div><br>
                <div class="form-group col-sm-4">
                    <label for="celular">Tipo vivienda:</label>
                      <select class="form-control" id="tipo_vivienda" name="tipo_vivienda" onchange="Tipo_vivienda();">
                        <option>{{$userdata[0]->tipo_vivienda}}</option>
                ...
                <div class="form-group col-sm-4">
                    <label for="celular">Estrato:</label>
                      <select class="form-control" id="estrato" name="estrato">
                        <option>{{$userdata[0]->estrato}}</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                ...
                <div class="form-group col-sm-4">
                    <label for="celular">Grupo sanguíneo:</label>
                      <select class="form-control" id="grupo_sanguineo" name="grupo_sanguineo">
                        <option>{{$userdata[0]->grupo_sanguineo}}</option>
                        <option>O-</option>
                        <option>O+</option>
                        <option>A-</option>
                        <option>A+</option>
                ...
                <div class="form-group col-sm-4">
                    <label for="celular">Ya te vacunaste contra el covid-19?:</label>
                      <select class="form-control" id="vacuna" name="vacuna" onchange="Vacuna();">
                        <option>{{$userdata[0]->vacunado_covid}}</option>
                        <option>Si</option>
                        <option>No</option>
                      </select>
                </div>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <div class="form-group">
                      <select class="form-control" id="genero" name="genero">
                        <option>{{$userdata[0]->gender}}</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="conyuge" name="conyuge" placeholder="" value="{{$userdata[0]->conyuge}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="celular">Tiene hijos:</label>
                      <select class="form-control" id="posee_hijos" name="posee_hijos" onchange="PoseeHijos();">
                        <option>{{$userdata[0]->posse_hijos}}</option>
                        <option>No</option>
                        <option>Si</option>
                      </select>
                </div>
                @if($userdata[0]->posee_hijos == 'Si')
                <div class="form-group col-sm-4" id="CantidadHijos">
                    <label for="extension">Cúantos hijos tiene:</label>
                    <input type="text" class="form-control" id="cantidad_hijos" name="cantidad_hijos" placeholder="" onkeypress="return valideKey(event);" onkeyup="MensajeDatosHijos();" value="{{$userdata[0]->cantidad_hijos}}">
                </div>
                @else
                ...
                <br><div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="contacto_emergencia" name="contacto_emergencia" placeholder=""  value="{{$userdata[0]->contacto_emergencia}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Parentesco contacto de emergencia:</label>
                      <select class="form-control" id="parentesco_contacto_emergencia" name="parentesco_contacto_emergencia" onchange="OtroFamiliar();">
                        <option>{{$userdata[0]->parentesco_contacto_emergencia}}</option>
                        <option>Madre</option>
                        <option>Padre</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="celular_contacto_emergencia" name="celular_contacto_emergencia" placeholder=""  onkeypress="return valideKey(event);" value="{{$userdata[0]->celular_contacto_emergencia}}">
                </div><br><br>
                ...
                <div class="form-group col-sm-4">
                    <label for="extension">Nivel de estudios:</label>
                      <select class="form-control" id="nivel_estudios" name="nivel_estudios">
                        <option>{{$userdata[0]->nivel_estudios}}</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="formacion_actual" name="formacion_actual" placeholder=""  value="{{$userdata[0]->formacion_actual}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Estudia actualmente:</label>
                      <select class="form-control" id="EstudiaActualmente" name="EstudiaActualmente" onchange="Estudia_actualmente();">
                        <option>{{$userdata[0]->estudia_actualmente}}</option>
                        <option>No</option>
                        <option>Si</option>
                      </select>
                </div>
                @if($userdata[0]->estudia_actualmente == 'Si')
                <div class="form-group col-sm-4" id="div_estudia_actualmente">
                    <label for="extension">Qué estudia actualmente:</label>
                    <input type="text" class="form-control" id="estudio_actual" name="estudio_actual" placeholder="" value="{{$userdata[0]->estudio_actual}}">
                </div><br>
                @else
                ...
                <div class="form-group col-sm-4">
                    <label for="extension">Compañia:</label>
                      <select class="form-control" id="Empresa" name="Empresa">
                        <option>{{$userdata[0]->empresa}}</option>
                ...
                <div class="form-group col-sm-4" id="div_estudia_actualmente">
                    ...
                    <input type="text" class="form-control" id="eps" name="eps" placeholder=""  value="{{$userdata[0]->eps}}">
                </div>
                <div class="form-group col-sm-4" id="div_estudia_actualmente">
                    <label for="extension">Fondo de pensiones:</label>
                    <input type="text" class="form-control" id="fondo_pensiones" name="fondo_pensiones" placeholder=""  value="{{$userdata[0]->fondo_pensiones}}">
                </div>
                <div class="form-group col-sm-4" id="div_estudia_actualmente">
                    <label for="extension">Fondo de cesantías:</label>
                    <input type="text" class="form-control" id="fondo_cesantias" name="fondo_cesantias" placeholder=""  value="{{$userdata[0]->fondo_pensiones}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Grupo de trabajo al que pertenece:</label>
                      <select class="form-control" id="grupo_trabajo" name="grupo_trabajo">
                        <option>{{$userdata[0]->grupo_trabajo}}</option>
                ...
                <div class="form-group col-sm-4">
                    <label for="extension">Sede donde labora:</label>
                      <select class="form-control" id="sede_labora" name="sede_labora" onchange="OtraSede();">
                        <option>{{$userdata[0]->sede_labora}}</option>
                ...
                <div class="form-group col-sm-4">
                    <label for="extension">Correo corporativo:</label>
                       <input type="text" class="form-control" id="correo_corporativo" name="correo_corporativo" placeholder="" value="{{$userdata[0]->email}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Celular corporativo:</label>
                       <input type="text" class="form-control" id="celular_corportativo" name="celular_corporativo" placeholder="" value="{{$userdata[0]->phone}}">
                </div>
                <div class="form-group col-sm-4">
                    <label for="extension">Extensión:</label>
                       <input type="text" class="form-control" id="extension" name="extension" placeholder="" value="{{$userdata[0]->extension}}">
                </div>
                ...
                <div class="form-group col-sm-4">
                           ...
                           <select class="form-control" id="vehiculo" name="vehiculo" onchange="SeleccionVehiculo();">
                              <option>{{$userdata[0]->vehiculo}}</option>
                              <option value="No">No</option>
                              <option value="Si">Si</option>
                           </select>
                        </div>
                </div>
                @if($userdata[0]->vehiculo == 'Si')
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Experiencia de conducción en años:</label>
                      <select class="form-control" id="experiencia_conduccion" name="experiencia_conduccion">
                        <option>{{$userdata[0]->experiencia_conduccion}}</option>
                        <option>1-5</option>
                        <option>6-10</option>
                        <option>11-15</option>
                        <option>16-21</option>
                ...
                <div class="form-group col-sm-4" id="div_tipo_vehiculo">
                    <label for="extension">Tipo de vehículo:</label>
                      <select class="form-control" id="tipo_vehiculo" name="tipo_vehiculo">
                        <option>{{$userdata[0]->tipo_vehiculo}}</option>
                        <option>Moto</option>
                        <option>Carro</option>
                ...
                <div class="form-group col-sm-4" id="div_categoria_licencia">
                    <label for="extension">Categoría licencia de conducción:</label>
                       <input type="text" class="form-control" id="categoria_licencia" name="categoria_licencia" placeholder="" value="{{$userdata[0]->categoria_licencia}}">
                </div>
                <div class="form-group col-sm-4" id="div_fecha_licencia">
                <label for="extension">Fecha de vencimiento licencia:</label>
                <input type='date' class='form-control' id='vencimiento_licencia' name='vencimiento_licencia' value="{{$userdata[0]->vencimiento_licencia}}">
                </div>
                <div class="form-group col-sm-4" id="div_placa_vehiculo">
                    <label for="extension">Placa vehículo:</label>
                       <input type='text' class='form-control' id='placa_vehiculo' name='placa_vehiculo' style='' value="{{$userdata[0]->placa_vehiculo}}">
                </div>
                <div class="form-group col-sm-4" id="div_marca">
                           <label for="vehiculo_marca">Marca:</label>
                            <input type="text" class="form-control" id="vehiculo_marca" name="vehiculo_marca" placeholder="" value="{{$userdata[0]->vehiculo_marca}}">
                </div>
                <div class="form-group col-sm-12" id="div_modelo">
                           <label for="vehiculo_mmodelo">Modelo:</label>
                            <input type="text" class="form-control" id="vehiculo_modelo" name="vehiculo_modelo" placeholder="" value="{{$userdata[0]->vehiculo_modelo}}">
                </div>
                @else
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Medio de transporte que utiliza para los trayectos Casa-Trabajo:</label>
                      <select class="form-control" id="medio_transporte" name="medio_transporte">
                        <option>{{$userdata[0]->medio_transporte}}</option>
                        <option>A pie</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Tiempo promedio diario de trayecto en horas (ida y vuelta):</label>
                      <select class="form-control" id="tiempo_promedio_trayecto" name="tiempo_promedio_trayecto">
                        <option>{{$userdata[0]->tiempo_promedio_trayecto}}</option>
                        <option>1</option>
                        <option>2-3</option>
                        <option>4-5</option>
                        <option>6-7</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Ha tenido accidentes de tránsito:</label><br><br>
                      <select class="form-control" id="accidentes_transito" name="accidentes_transito">
                        <option>{{$userdata[0]->accidentes_transito}}</option>
                        <option>No</option>
                        <option>Si</option>
                      </select>
                </div>
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Tipo de accidente más grave que he tenido:</label>
                      <select class="form-control" id="accidente_grave" name="accidente_grave">
                        <option>{{$userdata[0]->accidente_grave}}</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Te encuentras trabajando en:</label>
                      <select class="form-control" id="tipo_trabajo" name="tipo_trabajo">
                        <option>{{$userdata[0]->tipo_trabajo}}</option>
                        <option>Casa</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Factores de Riesgo que más percibe en sus desplazamientos por la vía pública (HUMANOS) :</label>
                      <select class="form-control" id="factores_riesgo_humanos" name="factores_riesgo_humanos">
                        <option>{{$userdata[0]->factores_riesgo_humanos}}</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Factores de Riesgo que más percibe en sus desplazamientos por la vía pública (VÍA Y ENTORNO):</label>
                      <select class="form-control" id="factores_riesgo_entorno" name="factores_riesgo_entorno">
                        <option>{{$userdata[0]->factores_riesgo_entorno}}</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Factores de Riesgo que más percibe en sus desplazamientos por la vía pública (VEHÍCULO):</label>
                      <select class="form-control" id="factores_riesgo_vehiculo" name="factores_riesgo_vehiculo">
                        <option>{{$userdata[0]->factores_riesgo_vehiculo}}</option>
                        <option>Mal estado de la vía</option>
                        <option>Ausencia de señales</option>
                        <option>Clima</option>
                        <option>Ninguno</option>
                ...
                <div class="form-group col-sm-4" id="div_experiencia_conduccion">
                    <label for="extension">Propuesta de mejoramiento internas para el plan estratégico de movilidad</label>
                      <select class="form-control" id="propuestas_internas" name="propuestas_internas">
                        <option>{{$userdata[0]->propuestas_internas}}</option>
