...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Legalización de gastos</div>
                @if($validacion == 1)
                <div class="card-body">
                ...
                @endif
                <div class="card-body">
                    <form action="{{url('gastos/save')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-4">
                                <label for="supplier_name">Empresa:</label>
                                    <select class="form-control" id="empresa" name="empresa" onchange="SeleccionCecos();">
                           ...
                           <div class="form-group col-sm-4">
                                <label for="date_data">Fecha pago reintegro:</label>
                            ...
                            <div class="coces" style="border:  1px solid; border-radius: 25px; border-left: 10%; background-color: #e4ffe0; border-width: 90%; border-style: none;">
                                <br><h5 class="text-center"><strong>Centros de Costos</strong></h5><br><br>
                                    <div class="form-row" style="margin-bottom: 1%; margin-left: 2%;margin-right: 2%;">
                                        <div class="col">
                                            <select class="form-control" id="coce" class="coce1" name="coce1" required>
                        ...
                        <div id="NuevoCampoAdjuntos"></div>
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" id="observacion_anticipo" name='observacion_anticipo' rows="4"></textarea>
                            </div>
                            <div class="row justify-content-center">
...
function AgregarCecos(indice){
    ...
    $.ajax({
      data:{ token, empresa },
      url: 'https://flora.tierragro.com/api/costcenterlegalizacion',
      type:'POST',
      dataType :'JSON',
      success:function(data){
        ...
        for (let j = 0; j < cantidad; j++) {
            codigos_cecos.push(data[j].code);
            nombres_cecos.push(data[j].name);

        $(".coce"+indice+"").append('<option value='+data[j].code+'>'+data[j].name+'</option>');
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        for (let i = 0; i < cantidad; i++) {
            $("#coce").append('<option value='+data[i].code+'>'+data[i].name+'</option>');
