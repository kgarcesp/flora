                ...
                <div class="card-body">
                    <form action="{{url('/anticipos/save')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-danger" role="alert">
                            <ul>
                                  <span>Tienes algún o algunos de los siguientes inconvenientes para generar el anticipo. Por favor toma los correctivos necesarios e intenta el proceso nuevamente:</span>
                                      <li>El archivo o archivos cargados no deben tener un tamaño superior a 1.5 MB</li>
                                      <li>La red de datos o internet a la cúal estas conectado/a es de baja intensidad</li>
                                      <li>El equipo que estas usando para realizar el proceso es demasiado lento para llevar a cabo el registro del anticipo</li>
                            </ul>
                        </div>
                        <div class="form-row">
