...
<i><h4>Da click en el botón azul de "Actualizar" para ingresar los empleados nuevos de la compañia</h4></i><br><br>
<form action="{{url('/actualizacionempleadosnuevos')}}"  method="post">
	@csrf
